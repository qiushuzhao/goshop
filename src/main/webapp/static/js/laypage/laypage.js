...
function() {
    ...
    function a(d) {
        var e = "laypagecss";
        a.dir = "dir" in a ? a.dir: f.getpath + "js/laypage/skin/laypage.css",
        new f(d),
    ...
    f.prototype.jump = function(a) {
        if (a) {
            ...
            function() {
            	...
            	var curr = h.value.replace(/\s|\D/g, "")|0;
                if(curr && curr <= c.pages){
                    c.curr = curr;
                    b.render();
                }else if(curr && curr > c.pages){
                    c.curr = c.pages;
                    b.render();
                }
